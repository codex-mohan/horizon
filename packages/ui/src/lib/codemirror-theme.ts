...
export function createCodeMirrorTheme(isDark: boolean): Extension {
  ...
  const highlightStyle = HighlightStyle.define([
    ...
    { tag: [t.name, t.deleted, t.character, t.macroName], color: "var(--cm-variable)" },
    ...
    { tag: [t.color, t.constant(t.name), t.standard(t.name)], color: "var(--cm-constant)" },
    { tag: [t.definition(t.name), t.separator], color: "var(--cm-variable)" },
    { tag: [t.typeName, t.className, t.number, t.changed, t.annotation, t.modifier, t.self, t.namespace], color: "var(--cm-type)" },
    ...
    { tag: [t.atom, t.bool, t.special(t.variableName)], color: "var(--cm-constant)" },
    { tag: [t.processingInstruction, t.string, t.inserted], color: "var(--cm-string)" },
    { tag: t.invalid, color: "var(--cm-foreground)", backgroundColor: "var(--destructive)" },
