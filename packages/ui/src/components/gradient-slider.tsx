...
interface GradientSliderProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange' | 'defaultValue'> {
  gradientColors?: {
    from?: string
    via?: string
    to?: string
      ...
      >
        ...
        <div
          ...
          className={`absolute block rounded-full shadow-md ${
            ...
            !disabled ? "cursor-grab active:cursor-grabbing hover:scale-110 hover:bg-white/40 hover:shadow-lg" : ""
          } ${isDragging ? "scale-105 bg-white/50 shadow-xl" : ""} ${
