  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn(
        ...
        "[&_svg[data-checked]]:text-[var(--primary)]",
        className
      )}
      data-inset={inset}
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      checked={checked}
      className={cn(
        "relative flex cursor-pointer items-center gap-2 rounded-md py-1.5 pr-2 pl-8 text-sm",
        "outline-hidden transition-colors",
        "focus:bg-[var(--accent)] focus:text-[var(--accent-foreground)]",
        "[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      className={cn("ml-auto text-[var(--muted-foreground)] text-xs tracking-widest", className)}
