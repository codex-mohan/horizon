    ...
    return (
      <div
        className={cn(
          ...
          "w-64 shrink-0 cursor-pointer transition-colors hover:bg-background/80",
      ...
      >
        ...
        <div className="relative flex shrink-0 overflow-hidden rounded-md bg-muted/50">
          {isImage && !imageError ? (
            ...
            <div className="flex h-10 w-10 items-center justify-center bg-muted/50 text-muted-foreground">
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-center overflow-hidden">
          ...
          <div className="flex items-center gap-2 text-muted-foreground text-xs">
            {fileExtension && (
              <span className="shrink-0 rounded bg-muted/50 px-1.5 py-0.5 font-medium text-[10px]">
                {fileExtension}
              </span>
            )}
  ...
  return (
    ...
    >
      ...
      <div className="relative h-24 overflow-hidden bg-muted/50">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-2">
            <div
              className={cn(
                ...
                /\.(jl)$/i.test(file.name) && "bg-linear-to-br from-purple-600 to-purple-700",
                /\.(elm)$/i.test(file.name) && "bg-linear-to-br from-cyan-500 to-cyan-600",
                /\.(ex|exs)$/i.test(file.name) && "bg-linear-to-br from-purple-600 to-purple-700",
        ...
        {/* File Size Badge */}
        {fileSize && (
          <div className="absolute top-1 right-1 rounded bg-black/60 px-1.5 py-0.5 font-medium text-[10px] text-white backdrop-blur-sm">
