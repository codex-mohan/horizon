                            ...
                            <div className="flex items-center gap-4 border-b bg-card p-4 shrink-0">
                                ...
                                {currentCheckpoint && (
                                    <div className="flex items-center gap-4 text-sm">
                                        <Badge variant="outline">ID: {currentCheckpoint.checkpoint.id.slice(0, 8)}...</Badge>
            ...
            <AlertDialog open={showDeleteThreadDialog} onOpenChange={setShowDeleteThreadDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to delete the thread "{selectedThreadId}"?
                            This will permanently delete all {threadData?.count || 0} checkpoints.
            ...
            <AlertDialog open={showDeleteCheckpointDialog} onOpenChange={setShowDeleteCheckpointDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to delete checkpoint #{selectedCheckpointIndex + 1}?
                            This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
