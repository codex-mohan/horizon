...
export default function ChatPage() {
  ...
  const { setCurrentThreadId, lastCreatedThreadId, setLastCreatedThreadId } =
  ...
  useEffect(() => {
    ...
    user,
    setCurrentThreadId,
    lastCreatedThreadId, // Clear the flag ONLY after we successfully mounted the thread view
