        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              <Field>
                <FieldLabel className="transition-colors duration-300 ease-in-out" htmlFor="email">
                  Email
                </FieldLabel>
                <Input
              ...
              <Field>
                <GradientButton glowIntensity="medium" type="submit" useThemeGradient width="full">
                  Login
                </GradientButton>
              </Field>
