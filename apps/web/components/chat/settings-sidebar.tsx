        ...
        <ScrollArea className="flex-1 p-4">
          <div className="space-y-6">
            ...
            <div className="space-y-2 stagger-item" style={{ animationDelay: "0.1s" }}>
              <Label htmlFor="top-p">Top P: {topP[0]}</Label>
              <GradientSlider
                id="top-p"
                min={0}
                max={1}
            ...
            <div className="space-y-2 stagger-item" style={{ animationDelay: "0.15s" }}>
              <Label htmlFor="frequency-penalty">Frequency Penalty: {frequencyPenalty[0]}</Label>
              <GradientSlider
                ...
                thumbClassName="w-5 h-5"
              />
              <p className="text-xs text-muted-foreground">Reduces repetition of tokens based on their frequency.</p>
            </div>

            <div className="space-y-2 stagger-item" style={{ animationDelay: "0.2s" }}>
              <Label htmlFor="presence-penalty">Presence Penalty: {presencePenalty[0]}</Label>
              <GradientSlider
                id="presence-penalty"
                min={-2}
                max={2}
                ...
                thumbClassName="w-5 h-5"
              />
              <p className="text-xs text-muted-foreground">Reduces repetition of topics and ideas.</p>
            </div>
            ...
            <div className="space-y-2 stagger-item" style={{ animationDelay: "0.25s" }}>
              ...
              />
              <p className="text-xs text-muted-foreground">Sets the behavior and personality of the AI.</p>
            </div>
          </div>
        </ScrollArea>

        <div className="p-4 border-t border-border">
          <GradientButton width="full" height={10} useThemeGradient glowIntensity="medium" onClick={onClose}>
            Apply Settings
          </GradientButton>
        </div>
      </div>
