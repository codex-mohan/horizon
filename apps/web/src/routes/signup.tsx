      ...
      >
        ...
        <div className="bg-bg-surface border border-border-subtle p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            >
              {isLoading ? <Loader2 size={16} className="mx-auto animate-spin" /> : "Create Account"}
            </button>
          </form>
          ...
          <p className="text-center text-xs text-text-muted mt-6">
            ...
            <Link to="/login" className="text-text-secondary hover:text-text-primary hover:underline">
              Sign in
            </Link>
          </p>
        </div>
