...
// Verify JWT token
async function verifyToken(token: string): Promise<{ userId: string; sessionId: string } | null> {
    try {
...
): Promise<{ success: boolean; user?: PublicUser; token?: string; error?: string }> {
    try {
...
export async function validateSession(token: string): Promise<{ valid: boolean; user?: PublicUser }> {
    try {
